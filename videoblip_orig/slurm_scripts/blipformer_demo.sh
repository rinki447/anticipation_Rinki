...
MODEL_NAME_OR_PATH="blip2_caps_model"
SAMPLE_PATH="/data/AmitRoyChowdhury/Anirudh/blipformer_captions_samples/e24ac385-52a7-4429-bc52-a7c341f99db5_start_frame_496_end_frame_736.pkl"

conda activate eilev
python3 blipformer_generate_text.py \
  --device cuda \
